    ...
    return (
      <div className="SvgButtons">
        <div className="painZone-svg-center">
          <div className="singles"></div>
          <div className="sides">
            <div className="Rside">
              <h5 onClick={this.partClicked} className="bParts" id="Hips">
                Hips
              </h5>
              <h5 onClick={this.partClicked} className="bParts" id="LElbow">
                L Elbow
              </h5>
              <h5 onClick={this.partClicked} className="bParts" id="LWrist">
                L Wrist
              </h5>
              <h5 onClick={this.partClicked} className="bParts" id="LKnee">
                L Knee
              </h5>
              <h5 onClick={this.partClicked} className="bParts" id="LAnkle">
                L Ankle
              </h5>
            </div>
            <div className="Lside">
              <h5 onClick={this.partClicked} className="bParts" id="Jaw">
                Jaw
              </h5>
              <h5 onClick={this.partClicked} className="bParts" id="RElbow">
                R Elbow
              </h5>
              <h5 onClick={this.partClicked} className="bParts" id="RWrist">
                R Wrist
              </h5>
              <h5 onClick={this.partClicked} className="bParts" id="RKnee">
                R Knee
              </h5>
              <h5 onClick={this.partClicked} className="bParts" id="RAnkle">
                R Ankle
              </h5>
            </div>
          </div>
